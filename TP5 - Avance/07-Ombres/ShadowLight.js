// Définition de la classe ShadowLight
...
class ShadowLight extends Light
{
    ...
    constructor(size)
    {
        ...
        this.m_MatProjectionLight = mat4.create();
        this.m_MatViewLight = mat4.create();
    ...
    drawShadowMap(scene, matViewCamera)
    {
        ...
        mat4.perspective(this.m_MatProjectionLight, Utils.radians(this.m_MaxAngle)*2.0, 1.0, this.m_Near, this.m_Far);
        ...
        mat4.lookAt(this.m_MatViewLight, this.m_PositionCamera, this.m_TargetCamera, vec3.fromValues(0,1,0));

        // appliquer la matrice de la scène
        mat4.multiply(this.m_MatViewLight, this.m_MatViewLight, matViewCamera);
        ...
        scene.onDraw(this.m_MatProjectionLight, this.m_MatViewLight);
