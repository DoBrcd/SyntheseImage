...
class FileHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            # fichier ordinaire ou dossier
            else:
                # dossier ? on lui rajoute main.html, mais ça peut faire un 404 au mauvais endroit
                if os.path.isdir(self.path): self.path += '/main.html'
                ...
                if os.path.isfile(self.path):
                    ...
                    if ext in mimetype.keys():
                        ...
                        self.send_error(406,'File type not allowed: %s'%self.path)
                else:
