...
class Scene
{
    ...
    onDrawFrame()
    {
        ...
        mat4.rotateX(this.m_Matrix, this.m_Matrix, Utils.radians(25.0* Utils.Time));
        mat4.rotateY(this.m_Matrix, this.m_Matrix, Utils.radians(-25.0* Utils.Time));
        mat4.rotateZ(this.m_Matrix, this.m_Matrix, Utils.radians(25.0* Utils.Time));
        mat4.translate(this.m_Matrix, this.m_Matrix, vec3.fromValues(0.25*Math.sin(Utils.radians(250.0* Utils.Time)), 0.0, 0.0));
