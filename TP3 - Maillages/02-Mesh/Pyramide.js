...
class Pyramide extends Mesh
{
    ...
    constructor()
    {
        ...
        // sommets
        let v0 = new Vertex(this,  0.0, 2.0,  0.0).setColor(0.0, 0.9, 0.0); // P0 vert
        let v1 = new Vertex(this,  1.0, 0.0,  0.0).setColor(1.0, 0.5, 0.0); // P1 orange
        let v2 = new Vertex(this,  0.0, 0.0, -1.0).setColor(0.0, 0.5, 1.0); // P2 bleu
        let v3 = new Vertex(this, -1.0, 0.0,  0.0).setColor(0.7, 0.0, 0.7); // P3 violet
        let v4 = new Vertex(this,  0.0, 0.0,  1.0).setColor(0.0, 0.0, 0.9); // P4 bleu foncé
