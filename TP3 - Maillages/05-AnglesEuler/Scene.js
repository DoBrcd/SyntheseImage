...
class Scene
{
    ...
    onDrawFrame()
    {
        ...
        mat4.rotateY(this.m_MatVM, this.m_MatVM, Utils.radians(10.0 * Utils.Time));
        mat4.rotateX(this.m_MatVM, this.m_MatVM, Utils.radians(25.0));
        mat4.rotateZ(this.m_MatVM, this.m_MatVM, Utils.radians(50.0));
