...
class Scene
{
    ...
    onKeyDown(code)
    {
        ...
        switch (code) {
            case 'Z':
                ...
                if (this.m_Distance < 5.0) this.m_Distance = 5.0;
                break;
            case 'S':
                this.m_Distance += 0.25;
                if (this.m_Distance > 25.0) this.m_Distance = 25.0;
                break;
        }
    }
    ...
    onSurfaceChanged(width, height)
    {
        ...
        mat4.perspective(this.m_MatP, Utils.radians(30.0), width / height, 0.1, 30.0);
    }
